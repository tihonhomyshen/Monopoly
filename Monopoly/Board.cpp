...
Board Board::create()
{
	...
	tmp.cells[2] = std::make_unique<EventField>("Penalty", "../images/chance.png");
	tmp.cells[3] = std::make_unique<CompanyField>(1, "Hugo Boss", "", "", 600, 0, 0, "../images/hugo_boss.png");
	tmp.cells[4] = std::make_unique<EventField>("skip", "../images/chance.png");
	...
	tmp.cells[8] = std::make_unique<EventField>("Penalty", "../images/chance.png");
	...
	tmp.cells[10] = std::make_unique<EventField>("skip", "../images/chance.png");
	...
	tmp.cells[17] = std::make_unique<EventField>("Penalty", "../images/chance.png");
	...
	tmp.cells[20] = std::make_unique<EventField>("skip", "../images/chance.png");
	tmp.cells[21] = std::make_unique<CompanyField>(7, "American Airlines", "", "", 2200, 0, 0, "../images/american_airlines.png");
	tmp.cells[22] = std::make_unique<EventField>("Penalty", "../images/chance.png");
	...
	tmp.cells[30] = std::make_unique<EventField>("skip", "../images/chance.png");
	tmp.cells[31] = std::make_unique<CompanyField>(9, "Holiday Inn", "", "", 3000, 0, 0, "../images/holiday_inn.png");
	tmp.cells[32] = std::make_unique<EventField>("skip", "../images/chance.png");
	...
	tmp.cells[36] = std::make_unique<EventField>("skip", "../images/chance.png");
	tmp.cells[37] = std::make_unique<CompanyField>(10, "Apple", "", "", 3500, 0, 0, "../images/apple.png");
	tmp.cells[38] = std::make_unique<EventField>("skip", "../images/chance.png");
